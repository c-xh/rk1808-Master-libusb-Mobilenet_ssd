...
import com.rockchip.inno.mobilenet_ssd.R;
...
public class PermissionUtils {
    ...
    public static final int READ_CODE_WRITE_EXTERNAL_STORAGE = 1;
    public static final int CODE_RECORD_AUDIO = 2;
    public static final int CODE_VIBRATE = 3;
    public static final int CODE_CAMERA = 4;
    public static final int CODE_RECEIVE_BOOT_COMPLETED = 5;
    public static final int CODE_DISABLE_KEYGUARD = 6;
    public static final int CODE_WAKE_LOCK = 7;
    public static final int CODE_ACCESS_WIFI_STATE = 8;
    public static final int CODE_CHANGE_WIFI_STATE = 9;
    public static final int CODE_BLUETOOTH = 10;
    public static final int CODE_BLUETOOTH_ADMIN = 11;
